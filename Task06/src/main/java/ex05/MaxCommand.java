 ...
 */
    ...
    public void execute() {
        ...
        System.out.println("Max done. Item #" + hexResult + " (Hex) found: " + viewResult.getItems().get(hexResult));
        System.out.println("Max done. Item #" + octResult + " (Oct) found: " + viewResult.getItems().get(octResult));
        progress = 100;
    }
/**
 @Override
